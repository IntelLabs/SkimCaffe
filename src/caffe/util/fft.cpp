...
void *caffe_cpu_fft_plan_dft_r2c_2d<float>(int n0, int n1,
  ...
  return fftwf_plan_dft_r2c_2d(n0, n1, in,
...
void *caffe_cpu_fft_plan_dft_r2c_2d<double>(int n0, int n1,
  ...
  return fftw_plan_dft_r2c_2d(n0, n1, in,
...
void *caffe_cpu_fft_plan_dft_c2r_2d<float>(int n0, int n1,
  ...
  return fftwf_plan_dft_c2r_2d(n0, n1, reinterpret_cast<fftwf_complex *> (in),
             out, flags);
}
template <>
void *caffe_cpu_fft_plan_dft_c2r_2d<double>(int n0, int n1,
         std::complex<double> *in, double *out, unsigned flags) {
  return fftw_plan_dft_c2r_2d(n0, n1, reinterpret_cast<fftw_complex*> (in),
             out, flags);
}
...
void *caffe_cpu_fft_plan_many_dft_r2c<float>(int rank, const int *n,
          ...
          unsigned flags) {
  return fftwf_plan_many_dft_r2c(rank, n, howmany, in, inemded, istride, idist,
...
void *caffe_cpu_fft_plan_many_dft_r2c<double>(int rank, const int *n,
         ...
         unsigned flags) {
  return fftw_plan_many_dft_r2c(rank, n, howmany, in, inemded, istride, idist,
              reinterpret_cast<fftw_complex*> (out), onembed, ostride, odist,
               flags);
}

template <>
void *caffe_cpu_fft_plan_many_dft_c2r<float>(int rank, const int *n,
          int howmany, std::complex<float> *in, const int *inemded, int istride, int idist,
          float *out, const int *onembed, int ostride, int odist,
          unsigned flags) {
  return fftwf_plan_many_dft_c2r(rank, n, howmany, reinterpret_cast<fftwf_complex *>(in), inemded, istride, idist,
              out, onembed, ostride, odist,
                flags);
}
template <>
void *caffe_cpu_fft_plan_many_dft_c2r<double>(int rank, const int *n,
         int howmany, std::complex<double> *in, const int *inemded, int istride, int idist,
         double *out, const int *onembed, int ostride, int odist,
         unsigned flags) {
  return fftw_plan_many_dft_c2r(rank, n, howmany, reinterpret_cast<fftw_complex*>(in), inemded, istride, idist,
              out, onembed, ostride, odist,
               flags);
}
