...
```
models/bvlc_reference_caffenet/train_script.sh 0.001 5e-5 0.0001 10 0 0 0 0 0 template_l1_solver.prototxt caffenet_0.57368.caffemodel
```
...
```
models/bvlc_reference_caffenet/train_script.sh 0.001 5e-5 0 0 0 0 0 0 0 template_finetune_solver.prototxt caffenet_pruned.caffemodel
```
