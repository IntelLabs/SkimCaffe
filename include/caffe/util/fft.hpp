...
template <typename Dtype>
void *caffe_cpu_fft_plan_many_dft_c2r(int rank, const int *n, int howmany,
    std::complex<Dtype> *in, const int *inemded, int istride, int idist,
    Dtype *out, const int *onembed, int ostride, int odist,
    unsigned flags);
