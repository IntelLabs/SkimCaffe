...
class FFTLayer : public BaseConvolutionLayer<Dtype> {
 public:
  /**
   ...
   */
  explicit FFTLayer(const LayerParameter& param)
      : BaseConvolutionLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "FFT"; }
 ...
 protected:
  ...
  int fft_map_real_size_, fft_map_complex_size_;
};
