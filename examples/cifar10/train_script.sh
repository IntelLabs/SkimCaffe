...
if [ "$#" -lt 7 ]; then
	...
	echo "Usage: train_script base_lr weight_decay threshold breadth_decay block_group_decay device_id template_solver.prototxt [finetuned.caffemodel/.solverstate]"
	exit
fi
base_lr=$1
weight_decay=$2
...
snapshot_path=$folder/${base_lr}_${weight_decay}_${threshold}_${breadth_decay}_${block_group_decay}_${current_time}
mkdir $snapshot_path
...
echo "prune_threshold: $threshold" >> $solverfile
